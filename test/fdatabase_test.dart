...
void main() {
  ...
  test('Saving default types (String, int, double, bool, DateTime)', () {
    ...
    check(fDb.get<DateTime>('dateTime'))
        .isA<DateTime>()
        .equals(DateTime(2024, 4, 9));
  });
  ...
  test(
      'Throwing `NotSupportedException` when type is not `Entity` or a default type',
      () {
    check(() => fDb.put<Something>('something', const Something()))
